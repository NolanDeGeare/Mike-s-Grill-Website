...
('Order of Toast (2 slices)', 'Two slices of white or wheat with butter and jelly.', 1.25, NULL, 'Breakfast'),
...
('Malt (Large)', 'Extra rich malt (large).', 3.50, NULL, 'Drinks'),
('Sundae', 'Sundae - pineapple, strawberry, chocolate, butterscotch.', 4.00, NULL, 'Desserts'),
...
('Twinburger', 'A hamburger and a cheeseburger served on a seeded bun.', 5.75, NULL, 'Sandwiches'),
('Hot Ham Sandwich', 'Generous portion of ham served on bun or bread.', 6.55, NULL, 'Sandwiches'),
...
('French Fries (Large)', 'Golden crispy fries, large order.', 3.50, NULL, 'Sides'),
('Baked Beans', 'Baked beans.', 2.60, NULL, 'Sides'),
('Cheese Fries', 'French fries topped with cheese.', 3.25, NULL, 'Sides'),
